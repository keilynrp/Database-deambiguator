# report-module-coverage Specification

## Purpose
Extend report coverage with authority-control, collaboration-graph and
journal-portfolio sections, ensure readiness language accounts for the authority
backlog, and keep every new section tenant-isolated and available in every
export format. Created by archiving change extend-report-module-coverage.
