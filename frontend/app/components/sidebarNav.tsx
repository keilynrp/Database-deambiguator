  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        translationKey: "nav.transformations",
      },
      {
        label: "Web Scrapers",
        href: "/scrapers",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        translationKey: "nav.exec_dashboard",
      },
      {
      ...
      },
      {
        ...
        translationKey: "nav.graph_analytics",
      },
      {
        ...
        translationKey: "nav.domain_compare",
      },
      {
        label: "My Dashboards",
        href: "/dashboards",
      ...
      },
      {
        ...
        icon: (
          <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582M4.157 7.582A11.953 11.953 0 0112 10.5c2.998 0 5.74-1.1 7.843-2.918" />
          </svg>
        ),
      ...
      },
      {
        ...
        translationKey: "nav.alert_channels",
      },
      {
        label: "API Keys",
      ...
      {
        label: "Bulk Editor",
        href: "/entities/bulk-edit",
        icon: (
          <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 010 3.75H5.625a1.875 1.875 0 010-3.75z" />
          </svg>
        ),
        translationKey: "nav.bulk_editor",
      },
      {
        label: "Webhooks",
      ...
      },
      {
        ...
        href: "/settings/scheduled-imports",
        icon: (
          <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
