        ...
        <div className="space-y-6">
            ...
            {!pipeline && !loading && (
                <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-gray-300 py-16 dark:border-gray-700">
                    ...
                    <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Data Harmonization Pipeline</p>
                    <p className="mt-1 text-xs text-gray-400 dark:text-gray-500">Click &quot;Load Pipeline&quot; to analyze your data and prepare cleaning steps</p>
                </div>
            )}
