                    ...
                    {uploadError && (
                        <div className="mt-4 rounded-xl border border-red-200 bg-red-50 p-4 dark:border-red-800 dark:bg-red-500/5">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-semibold text-red-800 dark:text-red-300">Import Failed</span>
                            </div>
                            <p className="mt-1 text-sm text-red-700 dark:text-red-400">{uploadError}</p>
                        </div>
                    )}
                </div>
