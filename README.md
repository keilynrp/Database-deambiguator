...
![Tests](https://img.shields.io/badge/Tests-4028_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 312 test files, 4028 tests
...
| Testing | pytest (4028 tests collected), Vitest (333 tests), Playwright |
...
**Current test stats:** 4028 backend tests collected across 312 test files. Frontend: 333 Vitest tests.
