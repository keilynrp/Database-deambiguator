...
![Tests](https://img.shields.io/badge/Tests-4032_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 313 test files, 4032 tests
...
| Testing | pytest (4032 tests collected), Vitest (333 tests), Playwright |
...
**Current test stats:** 4032 backend tests collected across 313 test files. Frontend: 333 Vitest tests.
