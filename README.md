...
![Tests](https://img.shields.io/badge/Tests-4053_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 314 test files, 4053 tests
...
| Testing | pytest (4053 tests collected), Vitest (333 tests), Playwright |
...
**Current test stats:** 4053 backend tests collected across 314 test files. Frontend: 333 Vitest tests.
