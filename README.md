...
![Tests](https://img.shields.io/badge/Tests-4052_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 314 test files, 4052 tests
...
| Testing | pytest (4052 tests collected), Vitest (333 tests), Playwright |
...
**Current test stats:** 4052 backend tests collected across 314 test files. Frontend: 333 Vitest tests.
