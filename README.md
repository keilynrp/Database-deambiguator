...
![Tests](https://img.shields.io/badge/Tests-3994_collected-28A745?logo=pytest&logoColor=white)
...
<!-- BEGIN GENERATED REPOSITORY METRICS: tree-backend-tests -->
  tests/                 312 test files, 3994 tests
...
| Testing | pytest (3994 tests collected), Vitest (332 tests), Playwright |
...
**Current test stats:** 3994 backend tests collected across 312 test files. Frontend: 332 Vitest tests.
