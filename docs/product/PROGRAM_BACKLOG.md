...
| EPIC-013 | Commercial Readiness and Credibility | Alinear claims, onboarding y readiness comercial con la realidad del producto | In progress | `README.md`, docs comerciales, onboarding, compliance baseline |
