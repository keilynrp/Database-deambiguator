...
| Credibilidad comercial y tecnica | EPIC-013 | US-046, US-047 | SPRINT-104 | `README.md`, `backend/routers/onboarding.py`, `frontend/app/components/OnboardingChecklist.tsx`, `frontend/app/components/WelcomeModal.tsx`, `docs/product/COMMERCIAL_MVP.md`, `docs/product/epics/EPIC-013-commercial-readiness-and-credibility.md` | Foco comercial inicial definido y onboarding mas honesto para salida a mercado | In progress |
