...
def test_author_nil_benchmark_dataset_is_reproducible():
    ...
    assert dataset["dataset_name"] == "ukip_author_nil_benchmark_v3"
...
def test_author_nil_benchmark_metrics_match_current_engine_baseline():
    ...
    assert results["totals"]["cases"] == 13
    ...
    assert results["metrics"] == {
        ...
        "route_accuracy": 1.0,
        "review_load_rate": 0.692,
        "linkable_review_rate": 0.429,
        "manual_review_rate": 0.538,
        "llm_path_rate": 0.154,
        "partial_fallback_available_rate": 0.5,
        "nil_reason_accuracy": 1.0,
        "avg_nil_score_on_predicted_nil": 0.908,
        "avg_complexity_score": 0.615,
    }
