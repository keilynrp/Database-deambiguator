...
if TYPE_CHECKING:
    from ..models.catalog_portal_response_source_context import CatalogPortalResponseSourceContext


T = TypeVar("T", bound="CatalogPortalResponse")


@_attrs_define
class CatalogPortalResponse:
    """
    Attributes:
        default_order (str):
        default_sort (str):
        ...
        source_context (CatalogPortalResponseSourceContext | Unset):
    ...
    source_context: CatalogPortalResponseSourceContext | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source_context, Unset):
            ...
            source_context = CatalogPortalResponseSourceContext.from_dict(_source_context)
        ...
        catalog_portal_response.additional_properties = d
        return catalog_portal_response
