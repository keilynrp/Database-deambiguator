...
T = TypeVar("T", bound="ScheduledImportUpdate")


@_attrs_define
class ScheduledImportUpdate:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scheduled_import_update = cls(
            interval_minutes=interval_minutes,
            is_active=is_active,
            name=name,
        )

        scheduled_import_update.additional_properties = d
        return scheduled_import_update
