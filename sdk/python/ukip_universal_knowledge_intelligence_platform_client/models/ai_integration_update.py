...
T = TypeVar("T", bound="AIIntegrationUpdate")


@_attrs_define
class AIIntegrationUpdate:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ai_integration_update = cls(
            api_key=api_key,
            base_url=base_url,
            model_name=model_name,
        )

        ai_integration_update.additional_properties = d
        return ai_integration_update
