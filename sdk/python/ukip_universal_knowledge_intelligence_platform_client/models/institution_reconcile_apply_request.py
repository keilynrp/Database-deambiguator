...
T = TypeVar("T", bound="InstitutionReconcileApplyRequest")


@_attrs_define
class InstitutionReconcileApplyRequest:
    """
    Attributes:
        auto_accept_threshold (float | Unset):  Default: 0.9.
    ...
    auto_accept_threshold: float | Unset = 0.9
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update({})
        if auto_accept_threshold is not UNSET:
            field_dict["auto_accept_threshold"] = auto_accept_threshold
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        auto_accept_threshold = d.pop("auto_accept_threshold", UNSET)
        ...
        institution_reconcile_apply_request = cls(
        ...
        institution_reconcile_apply_request.additional_properties = d
        return institution_reconcile_apply_request
