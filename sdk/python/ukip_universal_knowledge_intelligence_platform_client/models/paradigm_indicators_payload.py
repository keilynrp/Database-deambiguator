...
T = TypeVar("T", bound="ParadigmIndicatorsPayload")


@_attrs_define
class ParadigmIndicatorsPayload:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paradigm_indicators_payload = cls(
            document_types=document_types,
            journals_affinity=journals_affinity,
            terms=terms,
        )

        paradigm_indicators_payload.additional_properties = d
        return paradigm_indicators_payload
