...
def _get_kwargs(
    *,
    ...
    json_authority_id: int | None | Unset
    if isinstance(authority_id, Unset):
        json_authority_id = UNSET
    else:
        json_authority_id = authority_id
    params["authority_id"] = json_authority_id
